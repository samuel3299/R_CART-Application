...
//                    Calling query and equating to res
                    ...
                    ResultSet res1 = null;
                    try {
                        res = Main.connect.executeQuery("Select * from orders1");
                        res1 = Main.connect.executeQuery("Select max(SNO) from orders1");
...
//                            System.out.println(ordered);
                            String query = String.format("Insert Into Orders1 Values(%s,%s,'%s','%s','%s')",ordered,SNO.getText(),Main.email,productName.getText(),ProductPrice.getText());
//                            updating query after inserting it
                            ordered1 = Main.connect.UpdateQuery(query);
