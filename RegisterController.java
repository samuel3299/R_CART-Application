...
//        if any of column is empty ti will go else part
        ...
        if (!Name.getText().equals("") && !pass.getText().equals("") && !Dob.getText().equals("") && UserWork.getText().equals("Buyer")){
//            if all colums are filled
            int results = 0;
//            we are adding it to login table
        String query = String.format("Insert into Login values('%s','%s','%s','%s','%s')", Email.getText(), Name.getText(), pass.getText(), Dob.getText(),UserWork.getText());
...
//        setting login button to be visible
        ...
        if (!Name.getText().equals("") && !pass.getText().equals("") && !Dob.getText().equals("") && UserWork.getText().equals("Seller")){
//            if all colums are filled
            int results = 0;
//            we are adding it to login table
            String query = String.format("Insert into Login values('%s','%s','%s','%s','%s')", Email.getText(), Name.getText(), pass.getText(), Dob.getText(),UserWork.getText());
